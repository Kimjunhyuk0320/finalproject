...
public interface BookingRequestsMapper {
    ...
    // 유저 예약 목록
    public int rreqListTotalCount(Page page) throws Exception;
    ...
    // 클럽 대관 목록 카운트
    public int rentalListTotalCount(Page page) throws Exception;

    // 클럽 대관 목록
    public List<BookingRequests> rentalList(Page page) throws Exception;
